...
const seedDBResource = async () => {
    try {
        ...
        // Create a specialized Reviewer for demo
        const techReviewerRole = createdRoles.find(r => r.name === "Technical Reviewer");
        await Admin.create({
            email: "tech@example.com",
            password: adminPassword,
            role: techReviewerRole._id,
        });
        console.log("✓ Tech Reviewer: tech@example.com / admin123");
        ...
        console.log("\n✅ PBAC (Permission-based Access Control) seeded!\n");
        process.exit(0);
    } catch (error) {
