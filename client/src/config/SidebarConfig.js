...
export const sidebarItems = [
  ...
  { key: "sales", label: "Clients", path: "/admin/sales/clients", icon: Users, allowedRoles: ["admin", "sales", "procurement"] },
  { key: "sales", label: "Sales Orders", path: "/admin/sales/orders", icon: FileText, allowedRoles: ["admin", "sales", "procurement"] },
